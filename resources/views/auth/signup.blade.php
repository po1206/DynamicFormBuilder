...
<div class="wrapper">
    <form method="POST" action="" id="wizard" class="wizard clearfix" role="application">
        ...
        <section>
            <div class="inner">
                <div class="image-holder">
                    <img src="{{asset('/assets/images/register/form-wizard-1.jpg')}}" alt="">
                </div>
        ...
        <section>
            <div class="inner">
                <div class="image-holder">
                    <img src="{{asset('/assets/images/register/form-wizard-2.jpg')}}" alt="">
                </div>
                <div class="form-content">
                    <div class="form-header">
                        <h3>Registration</h3>
        ...
        <section>
            <div class="inner">
                <div class="image-holder">
                    <img src="{{asset('/assets/images/register/form-wizard-3.jpg')}}" alt="">
                </div>
                <div class="form-content">
                    <div class="form-header">
                        <h3>Registration</h3>
